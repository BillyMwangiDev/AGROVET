...
import { useRealtimeSalesData, SaleDataPoint } from '@/demos/hooks/useRealtimeSalesData';
...
// Suppress unused import warnings — Badge, Separator, Tooltip are available for extension
void Badge; void Separator; void TooltipProvider; void Tooltip; void TooltipContent; void TooltipTrigger; void Activity;
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <RechartsTooltip
                ...
                formatter={tooltipFormatter ? (value: unknown) => {
